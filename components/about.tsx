      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-3 sm:mb-6">
          <div className="flex items-center gap-1.5 sm:gap-2 mb-1">
            ...
            <span className="text-[8px] sm:text-xs uppercase tracking-widest text-amber-400">About Us</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-8">
          ...
          <div className="columns-2 gap-1 sm:gap-2">
            <div className="mb-1 sm:mb-2 break-inside-avoid">
          ...
          <div className="flex flex-col justify-center">
            <p className="text-[9px] sm:text-sm text-muted-foreground leading-relaxed mb-2 sm:mb-4">
            ...
            <p className="text-[9px] sm:text-sm text-muted-foreground leading-relaxed mb-3 sm:mb-6">
            ...
            <div className="grid grid-cols-3 gap-1.5 sm:gap-3">
              {features.map((feature, index) => (
                <div key={index} className="text-center group">
                  <feature.icon className="h-3 w-3 sm:h-4 sm:w-4 mx-auto mb-0.5 text-amber-400 transition-transform duration-300 group-hover:scale-110" strokeWidth={1.5} />
                  <p className="text-[7px] sm:text-[10px] font-medium text-foreground">{feature.label}</p>
                </div>
              ))}
            </div>
            ...
            <div className="mt-3 sm:mt-6">
              <a
                href="#contact"
                className="inline-flex items-center gap-1.5 text-[8px] sm:text-xs text-muted-foreground hover:text-amber-400 transition-colors"
              >
